...
namespace CS14_Kolar.dbTranscriptsDataSetTableAdapters {
...
SELECT ID, ItemDescription, ItemQuantity, ItemPrice FROM tblTransactions WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CS14_Kolar.Properties.Settings.Default.dbTranscriptsConnectionString;
        }
