...
namespace CS15_Kolar {
    ...
    public partial class dbTranscriptsDataSet : global::System.Data.DataSet {
        ...
        public partial class tblTransactionsDataTable : global::System.Data.TypedTableBase<tblTransactionsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public tblTransactionsRow AddtblTransactionsRow(string ItemDescription, int ItemQuantity, decimal ItemPrice) {
        ...
        public partial class tblTransactionsRow : global::System.Data.DataRow {
            ...
            public string ItemDescription {
                get {
                    return ((string)(this[this.tabletblTransactions.ItemDescriptionColumn]));
                }
                set {
                    this[this.tabletblTransactions.ItemDescriptionColumn] = value;
                }
            }
            ...
            public int ItemQuantity {
                get {
                    return ((int)(this[this.tabletblTransactions.ItemQuantityColumn]));
                }
                set {
                    this[this.tabletblTransactions.ItemQuantityColumn] = value;
                }
            }
            ...
            public decimal ItemPrice {
                get {
                    return ((decimal)(this[this.tabletblTransactions.ItemPriceColumn]));
                }
                set {
                    this[this.tabletblTransactions.ItemPriceColumn] = value;
                }
            }
        }
...
namespace CS15_Kolar.dbTranscriptsDataSetTableAdapters {
    ...
    public partial class tblTransactionsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[tblTransactions] WHERE (([ID] = @Original_ID) AND ([ItemDescri" +
                "ption] = @Original_ItemDescription) AND ([ItemQuantity] = @Original_ItemQuantity" +
                ") AND ([ItemPrice] = @Original_ItemPrice))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[tblTransactions] ([ItemDescription], [ItemQuantity], [ItemPric" +
                "e]) VALUES (@ItemDescription, @ItemQuantity, @ItemPrice);\r\nSELECT ID, ItemDescri" +
                "ption, ItemQuantity, ItemPrice FROM tblTransactions WHERE (ID = SCOPE_IDENTITY()" +
                ")";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[tblTransactions] SET [ItemDescription] = @ItemDescription, [ItemQuantity] = @ItemQuantity, [ItemPrice] = @ItemPrice WHERE (([ID] = @Original_ID) AND ([ItemDescription] = @Original_ItemDescription) AND ([ItemQuantity] = @Original_ItemQuantity) AND ([ItemPrice] = @Original_ItemPrice));
SELECT ID, ItemDescription, ItemQuantity, ItemPrice FROM tblTransactions WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CS15_Kolar.Properties.Settings.Default.dbTranscriptsConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, ItemDescription, ItemQuantity, ItemPrice FROM dbo.tblTransactions";
        ...
        public virtual int Fill(dbTranscriptsDataSet.tblTransactionsDataTable dataTable) {
        ...
        public virtual dbTranscriptsDataSet.tblTransactionsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dbTranscriptsDataSet.tblTransactionsDataTable dataTable = new dbTranscriptsDataSet.tblTransactionsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dbTranscriptsDataSet.tblTransactionsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_ItemDescription, int Original_ItemQuantity, decimal Original_ItemPrice) {
        ...
        public virtual int Insert(string ItemDescription, int ItemQuantity, decimal ItemPrice) {
        ...
        public virtual int Update(string ItemDescription, int ItemQuantity, decimal ItemPrice, int Original_ID, string Original_ItemDescription, int Original_ItemQuantity, decimal Original_ItemPrice, int ID) {
            if ((ItemDescription == null)) {
                throw new global::System.ArgumentNullException("ItemDescription");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(Original_ItemQuantity));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ItemDescription, int ItemQuantity, decimal ItemPrice, int Original_ID, string Original_ItemDescription, int Original_ItemQuantity, decimal Original_ItemPrice) {
            return this.Update(ItemDescription, ItemQuantity, ItemPrice, Original_ID, Original_ItemDescription, Original_ItemQuantity, Original_ItemPrice, Original_ID);
        }
    }
