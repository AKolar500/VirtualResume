...
namespace ic13_041713
{
    public partial class Form1 : Form
    {
        ...
        public void AddCourse(string strCourseName, int intCreditHrs,
                                            string strLetterGrade, bool blnHonors)
        {
            if (blnHonors)
            {
            ...
            try
            {
                if (lstTranscripts.SelectedIndex > -1)
                {
                    ...
                    else
                    {
                        ...
                        txtClass.Text = objTranscript.ClassName;
                        txtCreditHrs.Text = objTranscript.CreditHours.ToString();
                        txtGrade.Text = objTranscript.Grade;
        ...
        private void mnuFileOpen_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Critcal Error\n" + ex.Message, "Critical Error", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
        ...
        private void Form1_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            if (isDirty == true)
            {
                rslt = MessageBox.Show("Unsaved Data. Do you want to save?", "Save Data", MessageBoxButtons.YesNoCancel);
