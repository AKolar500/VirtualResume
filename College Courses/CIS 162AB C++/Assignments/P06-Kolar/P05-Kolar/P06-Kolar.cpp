// P06-Kolar.cpp : Defines the entry point for the console application.
//

/*If this doesn't work for you, there is a problem with the way you are running my
applications. This works on my end.*/

/*Also, pointers don't seem to work for me, which is surprising because I am using
call-by-value as if it were call-by-reference. My computer must be magical or something.*/
#include "stdafx.h"
#include <iostream>
using namespace std;
...
const double FICA_RATE = 0.06, FEDERAL_RATE = 0.15, STATE_RATE = 0.05;
