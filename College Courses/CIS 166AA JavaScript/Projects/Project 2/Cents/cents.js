...
var calculate_click = function () {
    ...
    var quarters = parseInt( $("quarters").value );
    var dimes = parseInt( $("dimes").value );
    var nickels = parseInt( $("nickels").value );
	...
	if (isNaN(investment) || investment <= 0) {
		...
		quarters = investment / 25;
		dimes = investment / 10;
		nickels = investment / 5;
		
		$("quarters").value = quarters.toFixed(2);
		$("dimes").value = dimes.toFixed(2);
		$("nickels").value = nickels.toFixed(2);
		$("pennies").value = investment.toFixed(2);
