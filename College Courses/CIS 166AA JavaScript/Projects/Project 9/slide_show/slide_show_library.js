...
var SlideShow = function ( params ) {
    ...
    // Set caption styles
    this.captionNode.parentNode.style.backgroundColor = "green";
    this.captionNode.style.color = "yellow";
...
SlideShow.prototype.togglePlay = function () {
    ...
    if ( this.play ) {
        ...
        // Get the computed style for the content node
        var contentNode = document.getElementById("content");
        var contentStyle = window.getComputedStyle(contentNode, null);

        // Set the caption styles
        this.captionNode.parentNode.style.backgroundColor = "red";
        this.captionNode.style.color = contentStyle.backgroundColor;        
    } else {
        this.timer = setInterval(
            function () { that.displayNextImage(); },
            this.speed
